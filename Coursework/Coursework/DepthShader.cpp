...
DepthShader::DepthShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd) // Use base shader constructor
{
	// Initialise shader using depth vertex and pixel shaders.
